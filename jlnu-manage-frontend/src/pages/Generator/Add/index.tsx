    ...
    <ProCard>
      ...
      {(!id || oldData) && (
        <StepsForm<API.GeneratorAddRequest | API.GeneratorEditRequest>
          ...
          onFinish={doSubmit}
        >
          <StepsForm.StepForm name="base" title="学院信息">
            <ProFormText name="name" label="学院" placeholder="请输入学院名称" />
            <ProFormSelect
              name="description"
              label="专业"
              placeholder="请选择专业"
          ...
          <StepsForm.StepForm name="fileConfig" title="专业信息">
            <ProFormText name="author" label="系主任" placeholder="请输入系主任姓名" />
            <ProFormSelect label="标签介绍" mode="tags" name="tags" placeholder="请输入标签" />
            <ProFormItem label="图片" name="picture">
              <PictureUploader biz="generator_picture" />
            </ProFormItem>
          </StepsForm.StepForm>
          <StepsForm.StepForm name="modelConfig" title="班级信息">
            <ProFormText name="basePackage" label="辅导员" placeholder="请输入辅导员姓名" />
            <ProFormText name="version" label="班级" placeholder="请输入班级" />
          </StepsForm.StepForm>
