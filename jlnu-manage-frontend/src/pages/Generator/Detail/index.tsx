      ...
      <Card>
        <Row justify="space-between" gutter={[32, 32]}>
          <Col flex="auto">
            ...
            <Typography.Paragraph type="secondary">辅导员：{data.basePackage}</Typography.Paragraph>
            <Typography.Paragraph type="secondary">班级：{data.version}</Typography.Paragraph>
            <Typography.Paragraph type="secondary">系主任：{data.author}</Typography.Paragraph>
